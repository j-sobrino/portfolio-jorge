    ...
    <nav aria-label="Social links" className={cn("flex items-center gap-4", className)}>
      {items.map(({ href, label, Icon }) => (
        <a
          ...
          aria-label={label}
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border/70 text-foreground/80 transition-transform duration-200 hover:scale-105 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
